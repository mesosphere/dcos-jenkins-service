...
### Older Archived Repository
This image was previously housed under https://github.com/mesosphere/dcos-jenkins-dind-agent

Older branches and tags can be found there.
